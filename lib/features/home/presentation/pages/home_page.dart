                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          FutureBuilder<String>(
                                            future: _getAddress(
                                              tr.id,
                                              double.parse(tr.originLat),
                                              double.parse(tr.originLng),
                                            ),
                                            builder: (ctx, snap) =>
                                                //  Text(
                                                //   'From: ${snap.data ?? "Loading..."}',
                                                //   style: TextStyle(
                                                //     color: Theme.of(context)
                                                //         .colorScheme
                                                //         .onPrimary
                                          ...
                                          FutureBuilder<String>(
                                            future: _getAddress(
                                              -tr.id,
                                              double.parse(tr.destinationLat),
                                              double.parse(tr.destinationLng),
                                            ),
                                            builder: (ctx, snap) =>
                                                // Text(
                                                //   'To: ${snap.data ?? "Loading..."}',
                                                //   style: TextStyle(
                                                //     color: Theme.of(context)
                                                //         .colorScheme
                                                //         .onPrimary
